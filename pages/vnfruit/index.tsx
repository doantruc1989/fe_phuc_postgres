...
function Index() {
  ...
  useEffect(() => {
    ...
    try {
      axios
        .get(
          `/product?page=${page}&take=20&filter=1&condition2=${condition2}&condition=${condition}&sortField=${sortField}&fromPrice=${fromPrice}&toPrice=${toPrice}&search=${search}&lang=${language}`
        )
        .then((res: any) => {
