...
function Index() {
  ...
  useEffect(() => {
    try {
      axios
        .get(
          `http://localhost:3007/product?page=${page}&take=20&filter=6&condition2=${condition2}&condition=${condition}&sortField=${sortField}&fromPrice=${fromPrice}&toPrice=${toPrice}&search=${search}`
        )
        .then((res: any) => {
