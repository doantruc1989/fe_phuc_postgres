  ...
  return (
    <Sidebar>
      ...
      <div className="flex items-center justify-center gap-3 ml-3 mt-3 bg-gray-100 p-2 w-fit">
        ...
        >
          <img className="w-6 h-4" src="/image/vietnam.png" alt="language" />
        </button>
        <button
          onClick={() => {
        ...
        >
          <img className="w-6 h-4" src="/image/england.png" alt="language" />
        </button>
        <button
          onClick={() => {
        ...
        >
          <img className="w-6 h-4" src="/image/japan.png" alt="language" />
        </button>
      </div>
    </Sidebar>
  );
