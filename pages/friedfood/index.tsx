...
function Index() {
  ...
  useEffect(() => {
    ...
    try {
      axios
        .get(
          `http://localhost:3007/product?page=${page}&take=20&filter=4&condition2=${condition2}&condition=${condition}&sortField=${sortField}&fromPrice=${fromPrice}&toPrice=${toPrice}&search=${search}&lang=${language}`
        )
        .then((res: any) => {
