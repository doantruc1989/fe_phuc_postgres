...
function Index() {
  ...
  useEffect(() => {
    ...
    try {
      axios
        .get(
          `http://localhost:3007/product?page=${page}&take=20&filter=3&condition2=${condition2}&condition=${condition}&sortField=${sortField}&fromPrice=${fromPrice}&toPrice=${toPrice}&search=${search}&lang=${language}`
        )
        .then((res: any) => {
  ...
  return (
    <div>
      <Breadcrumb className="w-full lg:w-11/12 mx-auto pt-5 border-b border-gray-100 pb-4">
        ...
        <Breadcrumb.Item>{t("Quà tặng trái cây")}</Breadcrumb.Item>
      </Breadcrumb>
      <div className="md:grid md:grid-cols-4 md:gap-6 w-full md:w-11/12 lg:w-9/12 mx-auto mb-6">
        ...
        <div className="md:col-start-2 md:col-end-5 mt-6">
          <h1 className="font-medium uppercase">{t("Quà tặng trái cây")}</h1>
